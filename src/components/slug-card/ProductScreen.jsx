...
const ProductScreen = ({ product, reviews, relatedProducts }) => {
  ...
  return (
    <>
      ...
      >
        {[
          ...(product.imgs?.map((i) => i.img) || []),
          // ...(product.product_ads_data?.map((a) => a.img) || []),
        ].map((src, idx) => (
          <SwiperSlide key={idx}>
            <Image
              src={src}
      ...
      <Image
        ...
        height={700}
        alt="Placeholder"
        className="w-full aspect-square rounded-lg bg-gray-100 object-cover"
      />
    )} */}
            ...
            <div className="lg:sticky top-44 mt-6 lg:mt-0 self-start z-10 mx-auto lg:col-span-4 lg:row-span-2 lg:row-end-2 lg:max-w-none">
              ...
              <div>
                ...
                {/* <div className="flex items-center text-sm text-gray-500 mt-3">
                  ...
                  Call Us for Order
                  <a
                    href={`tel:${globalSetting?.phone || "+91 90197 30300"}`}
                    className="font-bold text-emerald-500 ml-1"
                  >
                    {globalSetting?.phone || "+91 90197 30300"}
                  </a>
                </div> */}
                ...
                <div className="mt-6 border-t border-gray-200 pt-6">
                  ...
                  <div className="mt-4">
                    {/* <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 xl:grid-cols-5 2xl:grid-cols-6 gap-2 md:gap-3 lg:gap-3">
                              {product.fish_cutting_options?.slice(0, 10).map((product) => (
                                <CuttingCard
                                  key={product.id}
                                  product={product}
                                  currency={currency}
    ...
    <div className="flex items-center gap-3">
      ...
      <div>
        ...
        <p className="text-white/90 text-sm">
          Have specific preferences? Tell us how you want your fish prepared.
        </p>
      </div>
    </div>
